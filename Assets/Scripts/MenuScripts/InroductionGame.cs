            ...
            .OnComplete(() =>
            {
                ...
                .OnComplete(() =>
                {
                    ...
                    .OnComplete(() =>
                    {
                        ...
                        mainButtons[4].transform.GetComponent<RectTransform>()
                        .DOAnchorPos(mainButtons[4].GetComponent<RectTransform>().anchoredPosition + new Vector2(0, 80), timerToMove)
                        .SetDelay(delayButtons)
                        .SetEase(easeType)

                        .OnComplete(() =>
                        {
                            mainButtons[5].transform.DOScaleX(1, timerToAppear).SetEase(easeType);
